...
CREATE TABLE IF NOT EXISTS `vt_student` (
  ...
  `studeent_id` varchar(11) NOT NULL COMMENT '學號',
  `studeent_password` varchar(40) NOT NULL COMMENT '密碼',
  `studeent_name` varchar(6) NOT NULL COMMENT '名字',
...
(1, '投出你最喜歡的專業課程', '2015-09-03 20:40:38', '2016-02-28 00:00:00', '課務組', ''),
...
--
ALTER TABLE `vt_list`
  MODIFY `vt_id` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT '//自动编号',AUTO_INCREMENT=17;
--
